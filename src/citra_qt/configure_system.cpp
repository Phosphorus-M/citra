...
void ConfigureSystem::setConfiguration(bool emulation_running) {
    ...
    if (!enabled) {
        ...
        ui->edit_username->setText(QString::fromUtf16(reinterpret_cast<const ushort*>(username.data()))); // Should be QString::fromStdU16String(username) in Qt 5
...
void ConfigureSystem::applyConfiguration() {
    ...
    // apply username
    // should be std::u16string new_username = ui->edit_username->text().toStdU16String(); in Qt 5
